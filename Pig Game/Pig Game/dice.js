...
function roolDice(randomNumber){
    initialDice.src = "dice-1.png";
    switch(randomNumber){
        case 1: return currentDice.src = "dice-1.png";
        case 2: return currentDice.src = "dice-2.png";
        case 3: return currentDice.src = "dice-3.png";
        case 4: return currentDice.src = "dice-4.png";
        case 5: return currentDice.src = "dice-5.png";
        case 6: return currentDice.src = "dice-6.png";
...
function winnnerPlayer(){
    if(Number(totalPlayer1.textContent) >= 10){
        document.getElementById("name--0").textContent = "Player 1 Wins";
        setTimeout(function(){
            resetGame();
       },1000);
    }
    else if(Number(totalPlayer2.textContent) >= 10){
